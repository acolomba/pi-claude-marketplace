...
| spike-findings-pi-claude-marketplace | Implementation blueprint from spike experiments on removing backward-compat migration code (state.json field-fills, claude-plugins.json first-run bootstrap) in favor of a version-mismatch staleness gate. Requirements, proven patterns, and verified knowledge for that removal. Auto-loaded during implementation work on it.                                                                                                                                                                                                                                                                        | `.claude/skills/spike-findings-pi-claude-marketplace/SKILL.md` |
