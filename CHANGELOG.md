...
- Miscellaneous bug fixes in agent discovery, marketplace aliases, path containment, `mcpServers` validation, hook `if` rules, compaction hook payloads, update cleanup, notification counts, and per-scope discovery. (#181)
