# Requirements Archive: v1.20 transitive-dependencies

**Archived:** 2026-09-24
**Status:** SHIPPED

The next milestone will define a new `.planning/REQUIREMENTS.md`. For current
project status, see `.planning/PROJECT.md`.
