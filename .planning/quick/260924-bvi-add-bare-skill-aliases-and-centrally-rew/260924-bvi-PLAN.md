...
status: in_progress
date: 2026-09-24
description: Add bare skill aliases and centrally rewrite installed plugin Markdown references for release 0.19.2
---
...
2. Add bare interactive aliases and completion for loaded marketplace skills while keeping native `/skill:` names and command/template priority. Verify lifecycle and collisions.
