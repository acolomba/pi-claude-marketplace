...
- [x] **Phase 117: Measured `agent()` failure evidence** — the live canary drives the host engine's `agent()` failure path with a negative control, and the doc restates the divergence at the grade it was actually measured to (WEVID-01, WEVID-02, WDOCS-02) (completed 2026-09-09)
...
- [x] 117-03-PLAN.md — Correct the archived record and the stale live pointers, then take the phase through its gate
...
| 117. Measured `agent()` failure evidence | 3/3 | Complete    | 2026-09-09 |
