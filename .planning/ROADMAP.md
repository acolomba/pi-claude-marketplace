...
- [x] 85-02-PLAN.md — Land the `{malformed mcp}` closed-set failure-class reason token and route `malformed mcp reference:` notes to it without reclassifying inline `malformed mcpServers` (MCPR-03 / D-02).
