...
- [ ] **108-01** (`108-01-PLAN.md`, `P108-01`) - `extensions/pi-claude-marketplace/domain/auth-registry.ts` → `tests/domain/auth-registry.test.ts`
...
- [ ] **110-06** (`110-06-PLAN.md`, `P110-06`) - `extensions/pi-claude-marketplace/persistence/locations.ts` → `tests/persistence/locations.test.ts`
- [ ] **110-07** (`110-07-PLAN.md`, `P110-07`) - `extensions/pi-claude-marketplace/persistence/migrate-config.ts` → `tests/persistence/migrate-config.test.ts`
- [ ] **110-08** (`110-08-PLAN.md`, `P110-08`) - `extensions/pi-claude-marketplace/persistence/migrate.ts` → `tests/persistence/migrate.test.ts`
...
- [ ] **110-10** (`110-10-PLAN.md`, `P110-10`) - `extensions/pi-claude-marketplace/transaction/phase-ledger.ts` → `tests/transaction/phase-ledger.test.ts`
- [ ] **110-11** (`110-11-PLAN.md`, `P110-11`) - `extensions/pi-claude-marketplace/transaction/rollback.ts` → `tests/transaction/rollback.test.ts`
...
- [ ] **112-01** (`112-01-PLAN.md`, `P112-01`) - `extensions/pi-claude-marketplace/bridges/hooks/async-rewake/pid-table.ts` → `tests/bridges/hooks/async-rewake/pid-table.test.ts`
...
- [ ] **112-15** (`112-15-PLAN.md`, `P112-15`) - `extensions/pi-claude-marketplace/bridges/hooks/payloads/post-compact.ts` → `tests/bridges/hooks/payloads/post-compact.test.ts`
- [ ] **112-16** (`112-16-PLAN.md`, `P112-16`) - `extensions/pi-claude-marketplace/bridges/hooks/payloads/post-tool-use-failure.ts` → `tests/bridges/hooks/payloads/post-tool-use-failure.test.ts`
- [ ] **112-17** (`112-17-PLAN.md`, `P112-17`) - `extensions/pi-claude-marketplace/bridges/hooks/payloads/post-tool-use.ts` → `tests/bridges/hooks/payloads/post-tool-use.test.ts`
- [ ] **112-18** (`112-18-PLAN.md`, `P112-18`) - `extensions/pi-claude-marketplace/bridges/hooks/payloads/pre-compact.ts` → `tests/bridges/hooks/payloads/pre-compact.test.ts`
- [ ] **112-19** (`112-19-PLAN.md`, `P112-19`) - `extensions/pi-claude-marketplace/bridges/hooks/payloads/pre-tool-use.ts` → `tests/bridges/hooks/payloads/pre-tool-use.test.ts`
- [ ] **112-20** (`112-20-PLAN.md`, `P112-20`) - `extensions/pi-claude-marketplace/bridges/hooks/payloads/session-end.ts` → `tests/bridges/hooks/payloads/session-end.test.ts`
...
| ---------------------------------------- | -------------: | --------------- | --------- |
| 108. Domain and Platform                 |           0/23 | Not started     | -         |
