...
Status: every plan in the phase is EXECUTED. 116-28 (register) closed the last one, wave 6. Code review has now RUN and its two CRITICAL findings are CLOSED under the D-116-15 licence; the remaining gates — aggregate, regression, verification, plus the eight review findings outside that licence — stay with the orchestrator, along with the deferred 173/204 pair total and MOD-09
