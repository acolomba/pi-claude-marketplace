...
updated: 2026-07-31T07:45:00Z
---

## Current Test

number: 1
name: DOC-05 prose-quality confirmation against the research Stale-Claim Inventory §B
expected: |
  The amended docs/research/claude-hooks-vs-pi-events.md reads as an
  internally-consistent, well-worded correction of every §B row — not just
  factually correct (machine-verified) but well-phrased and unsurprising to a
  reader who knows the inventory.
