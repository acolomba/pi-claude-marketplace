...
| `spawn-helpers.test.ts` | A3 exact transform plus A2 command boundary         | Prove exec form versus shell form and the full UTF-8 serialization boundary. Assert exact bytes, marker precedence, permitted overshoot, wrapping, and source non-mutation.                                              |
