...
| `will uninstall`       | optional  | absent         | absent    | optional |
...
- [`extensions/pi-claude-marketplace/shared/notification-types.ts`](../extensions/pi-claude-marketplace/shared/notification-types.ts) -- the closed-set unions and discriminated notification unions, including `Reason` (consumed by the 16 reason-bearing plugin variants), `PluginStatus`, and `MarketplaceStatus`.
