...
type PluginNotificationMessage =
  ...
  | PluginAvailableMessage // status: "available";    NO scope (SNM-11); reasons? (OUT-02 / D-104-03)
  | PluginRemoteMessage // status: "remote";       NO scope (SNM-11); reasons? (OUT-05 / D-104-06); ◌ (RSTA-01)
