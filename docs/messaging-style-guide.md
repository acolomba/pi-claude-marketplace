...
### 14.1 Proposed new wording (Phase 13 applies)
...
Phase 13's planner has FINAL discretion on the exact wording. The proposal above satisfies the structural constraints (sentence form, terminal period, no compact-grammar tokens, no severity prefix); Phase 13 may tighten or expand based on operator-feedback channels available at refactor time. Phase 12 ships the contract, not the bytes.
