...
Nothing here changes how the tests run, what the LCOV contains, or the whole-tree complexity and duplication limits in `.fallowrc.json`.
...
`npm run check` and CI do not run these commands yet.
