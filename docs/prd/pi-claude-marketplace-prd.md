...
| **SK-6** | Loaded marketplace skills MUST offer bare `/name` completion and invocation in interactive Pi sessions after `/reload`. The native `/skill:name` form remains available. An existing command or prompt template with the bare name takes priority.                                                                                                                                                                                                                                                    |
