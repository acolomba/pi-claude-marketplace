...
The user-facing command surface. Phase 6 lands argument parsing for `/claude:plugin <subcommand>`, completion providers, the `claude_marketplace_list` LLM tool, and the dispatch table that maps subcommands to orchestrators.
