...
// `agents` / `workflows` / `mcpServers`. The supported-kind tuple is the
// PUBLIC closed set; the path-validation loop iterates a PRIVATE subset
 ...
 * subset; hooks-config discovery remains the separate mode-agnostic stage
 * below.
 */
