...
import type * as _target from "../../../../extensions/claude-marketplace/edge/handlers/plugin/install.ts";
...
test.skip('shim :: valid args call installPlugin with { ctx, pi, scope: "user", cwd, marketplace, plugin }', () => {});
test.skip('shim :: --scope project calls installPlugin with scope: "project"', () => {});
