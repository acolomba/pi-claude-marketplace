...
import type * as _target from "../../../../extensions/claude-marketplace/edge/handlers/marketplace/remove.ts";
...
test.skip("shim :: missing name positional emits USAGE", () => {});
test.skip("shim :: valid name calls removeMarketplace with { ctx, scope?, cwd, name }", () => {});
