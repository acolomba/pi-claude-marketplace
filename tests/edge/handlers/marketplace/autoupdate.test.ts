...
import type * as _target from "../../../../extensions/claude-marketplace/edge/handlers/marketplace/autoupdate.ts";
...
test.skip("dual-form :: makeAutoupdateHandler(true) calls setMarketplaceAutoupdate with enabled: true", () => {});
test.skip("dual-form :: makeAutoupdateHandler(false) calls setMarketplaceAutoupdate with enabled: false", () => {});
test.skip("shim :: bare form (no name) propagates name: undefined", () => {});
test.skip("shim :: named form propagates name", () => {});
test.skip("shim :: --scope user/project propagated", () => {});
