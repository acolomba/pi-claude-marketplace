...
import type * as _target from "../../../../extensions/claude-marketplace/edge/handlers/marketplace/list.ts";
...
test.skip("shim :: no positional calls listMarketplaces with scope: undefined", () => {});
test.skip('shim :: --scope user calls listMarketplaces with scope: "user"', () => {});
test.skip('shim :: --scope project calls listMarketplaces with scope: "project"', () => {});
