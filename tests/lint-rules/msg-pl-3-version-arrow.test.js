...
//
// RuleTester companion for `msg-pl-3-version-arrow`. The rule is a
// meta-assertion (D-14-09 LOCKED) -- its `create()` returns a no-op
// `Program: () => {}` visitor. The structural enforcement lives in the
// version-slot formatter inside `presentation/compact-line.ts` and in
...
import rule from "./msg-pl-3-version-arrow.js";
...
ruleTester.run("msg-pl-3-version-arrow", rule, {
  valid: [
