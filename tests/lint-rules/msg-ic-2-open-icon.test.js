...
//
// RuleTester companion for `msg-ic-2-open-icon`. The rule is a
// meta-assertion (D-14-09 LOCKED) -- its `create()` returns a no-op
// `Program: () => {}` visitor. The structural enforcement lives in the
// file-private `ICON_AVAILABLE` constant at `presentation/compact-line.ts:63`
// and the renderer's per-shape icon dispatch fn.
//
...
import rule from "./msg-ic-2-open-icon.js";
...
ruleTester.run("msg-ic-2-open-icon", rule, {
  valid: [
