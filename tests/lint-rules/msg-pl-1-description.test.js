...
//
// RuleTester companion for `msg-pl-1-description`. The rule is a
// meta-assertion (D-14-09 LOCKED) -- its `create()` returns a no-op
// `Program: () => {}` visitor. The structural enforcement lives in
// `tests/architecture/catalog-uat.test.ts` byte-equality and in the
// `description?` field being declared ONLY on `PluginListRow`.
//
...
import rule from "./msg-pl-1-description.js";
...
ruleTester.run("msg-pl-1-description", rule, {
  valid: [
