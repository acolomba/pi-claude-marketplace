...
//
// RuleTester companion for `msg-pl-6-version-non-success`. The rule is
// a meta-assertion (D-14-09 LOCKED) -- its `create()` returns a no-op
// `Program: () => {}` visitor. The structural enforcement lives in the
// per-shape renderers in `presentation/compact-line.ts` (and
// `MarketplaceRow` lacking a `version` field) plus
...
import rule from "./msg-pl-6-version-non-success.js";
...
ruleTester.run("msg-pl-6-version-non-success", rule, {
  valid: [
