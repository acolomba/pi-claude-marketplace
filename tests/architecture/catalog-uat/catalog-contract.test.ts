...
const EXPECTED_STATE_COUNT = 191;
const EXPECTED_UTF8_BYTES = 24_052;
...
test("catalog contract matches all 20 fixture modules to 191 exact documented states", async () => {
