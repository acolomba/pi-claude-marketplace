...
//
// T-d8i-01 re-pin: provenance now renders as frontmatter keys after
// inheritSkills instead of a body HTML comment. Every constant below was
// regenerated to that layout; each fixture's distinguishing content
// (warnings, droppedFields, CRLF trailing byte) is preserved unchanged.
