...
//
// T-d8i-01 re-pin: provenance now renders under a single `piSubagentMetadata`
// block-list after inheritSkills instead of a body HTML comment. Every
// constant below was regenerated to that layout; each fixture's
// distinguishing content (warnings, droppedFields, CRLF trailing byte) is
// preserved unchanged.
