...
const SEALED_REQUIREMENT_SIGNATURES = Object.freeze({
  ...
  "RCOV-01": "sha256:2132921f3e3e17e4251051b54e36c4a9dc9d0529fa6e0908226209068a714050",
  "RCOV-02": "sha256:075ab63a708d0efb431f12b4bdd0e462cf03af6c130f33c107fe6e3983f28ac1",
  "RCOV-03": "sha256:72b3e7c32953e06484230e4ea157c886846ed76ec612ab4047a670d7f34262c9",
  "RCOV-04": "sha256:301729d0a8d910d7ddfbafce811280e5966236aa097a48ccf639426f5b89be30",
...
const SEALED_REQUIREMENT_ROUTES = Object.freeze({
  ...
  "CLOSE-02": Object.freeze({ route: "Phase 9", status: "Complete" }),
  "GGAT-01": Object.freeze({ route: "Phase 7", status: "Complete" }),
  "GGAT-02": Object.freeze({
    route: "Evidence/history (formerly Phase 7)",
    status: "Evidence only",
  }),
  "GGAT-03": Object.freeze({ route: "Phase 7", status: "Complete" }),
  "GGAT-04": Object.freeze({ route: "Phase 7", status: "Complete" }),
  ...
  "RCOV-01": Object.freeze({ route: "Phase 8", status: "Complete" }),
  "RCOV-02": Object.freeze({ route: "Phase 8", status: "Complete" }),
  "RCOV-03": Object.freeze({ route: "Phase 8", status: "Complete" }),
...
function addRequirementLocation(locations, id, section, message, violations) {
  if (locations.has(id)) {
    violations.push(violation("duplicate-requirement", id, message));
  } else {
    locations.set(id, section);
  }
}
  ...
  for (const line of markdown.split("\n")) {
    ...
    if (historical !== null) {
      addRequirementLocation(
        ...
        historical[1],
        section,
        "requirement is recorded more than once",
        violations,
      );
    }
  }
